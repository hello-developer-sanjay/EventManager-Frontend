...
import { updateLayout, updateColor, updateFontFamily, updateFontSize, updateLineHeight, updateBackgroundImage, updateBorderRadius, updateBoxShadow } from '../redux/actions/settingActions.jsx';
